//https://schoolnot.tpowep.com/notebook-by-grade?grade=12
//getNotebookgrde
...
class getNotebookgrde extends StatefulWidget {
  ...
  getNotebookgrde({ required this.name, required this.id});

  @override
  _getNotebookgrdeState createState() => _getNotebookgrdeState();
}

class _getNotebookgrdeState extends State<getNotebookgrde> {
  ...
  Future<void> _fetchNotebooks() async {
    try {
      final notebooks = await _notebookService.fetchNotebooksgrade(widget.id);
      setState(() {
